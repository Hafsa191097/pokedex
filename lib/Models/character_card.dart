import 'package:Pokedex/data/repository/page_response.dart';
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      child: Image.network(
                        PokemonList(id: widget.state.pokemonList[widget.index].id, name: widget.state.pokemonList[widget.index].name).imageUrl,
                        height:135,
                        fit: BoxFit.cover,
                      ),
                    ),
